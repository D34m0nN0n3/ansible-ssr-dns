...
<table>
    ...
    <tr>
        ...
        <td style="min-width:50px"><input class="mod" type="number" name="TTL" id="ttl" maxlength="6" step="10" min="60" max="864000" required placeholder="TTL в секундах (86400)" /><br></td>
